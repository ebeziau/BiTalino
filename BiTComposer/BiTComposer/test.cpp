...
int main()
{
    try
    {
       ...
       //FMOD_System_PlaySound(system, tir, FMOD_CHANNEL_FREE, 0, NULL);
       //FMOD_System_PlaySound(system, tir, FMOD_ChannelGroup_Release, 0, NULL);
      ...
      */
        ...
        do //A CHAQUE do ON PREND UN NOUVEAU VECTEUR DE FRAMES
        {
            ...
            //affichage des 2 premi�res frames d'un bloc
            /*printf("%d %d ; %d %d\n",   // dump the first frame
             f.seq, f2.seq,
